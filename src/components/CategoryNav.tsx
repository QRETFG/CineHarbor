...
export default function CategoryNav() {
  return (
    <section id="分类" className="max-w-6xl mx-auto px-4 mt-12 scroll-mt-20">
        ...
        {categories.map((cat, i) => {
          ...
          return (
            <button
              ...
              className="sketch-card sketch-border bg-surface p-4 flex flex-col items-center gap-2 shadow-sketch hover:bg-sticky transition-colors cursor-pointer"
            >
